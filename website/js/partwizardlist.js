  $(document).ready(function(){
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        	...
        	{
            document.getElementById("filter").innerHTML = '<div class="row"><div class="col s12">Select Part Type:</div></div>' + xmlhttp.responseText;
          }
          else
        	{
    ...
    xmlhttp.open("POST", "wizardwand.php?id=-1&method=getPartTypesList", true);
    xmlhttp.send();
	}
	...
	function partTypeSelected(selId, selName, selImg)
	{
	    ...
	    xmlhttp.open("POST", "wizardwand.php?id=" + selId + "&method=getPartTypesList", true);
	    xmlhttp.send();
	  }
	  else
  	{
...
//          		displayLength();
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        	if(xmlhttp.responseText != "")
        	{
            document.getElementById("filter").innerHTML = '<div class="row"><div class="col s12">Select Grade:</div></div>' + xmlhttp.responseText;
					  $(document).ready(function(){
						    $('.collapsible').collapsible({
						      accordion : false // A setting that changes the collapsible behavior to expandable instead of the default accordion style
						    });
    ...
    xmlhttp.open("POST", "wizardwand.php?method=getGradesList", true);
    xmlhttp.send();
	}
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        	if(xmlhttp.responseText != "")
        	{
            document.getElementById("filter").innerHTML = '<div class="row"><div class="col s12">Select Material:</div></div>' + xmlhttp.responseText;
					  $(document).ready(function(){
						    $('.collapsible').collapsible({
						      accordion : false // A setting that changes the collapsible behavior to expandable instead of the default accordion style
						    });
    ...
    xmlhttp.open("POST", "wizardwand.php?method=getMaterialsList", true);
    xmlhttp.send();
    ...
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        	if(xmlhttp.responseText != "")
        	{
            document.getElementById("filter").innerHTML = '<div class="row"><div class="col s12">Select Finish:</div></div>' + xmlhttp.responseText;
					  $(document).ready(function(){
					    $('.collapsible').collapsible({
					      accordion : false // A setting that changes the collapsible behavior to expandable instead of the default accordion style
					    });
    ...
    xmlhttp.open("POST", "wizardwand.php?method=getFinishesList", true);
    xmlhttp.send();
